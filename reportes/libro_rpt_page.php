...
$capitulos_array = $capitulos->leerCapitulosLibro($conn, $libro);
...
<page backtop="14mm" backbottom="14mm" backleft="10mm" backright="10mm" style="font-size: 12pt" backimg="../imgs/logo.fw.png">
    <h1 style="text-align: center; font-size: 45pt;">
        <?php print $libros_array["titulo"]; ?>
    </h1>
    <h3 style="text-align: center; font-size: 30pt;">
        <?php print $libros_array["subtitulo"]; ?>
    </h3>
</page>

<!-- Capitulo-->
<?php for ($j=0; $j < count($capitulos_array); $j++) { ?>
...
<page backtop="14mm" backbottom="14mm" backleft="10mm" backright="10mm" style="font-size: 12pt" backimg="../imgs/logo.fw.png">
    ...
    <?php
        $t = "Capitulo ".$capitulos_array[$j]["numero"].": ";
        $t.=$capitulos_array[$j]["titulo"];
        print '<bookmark title="'.$t.'" level="0"></bookmark>';
        print '<br><h3>'.$t.'</h3>';
        print '<br><p><b>Objetivo:</b> ';
        print html_entity_decode($capitulos_array[$j]["objetivo"]).'</p>';
        print '<br><p><b>Introducción:</b> ';
        print html_entity_decode($capitulos_array[$j]["introduccion"]).'</p>';
    ?>
</page>
    <?php
    $capitulo = $capitulos_array[$j]["numero"];
