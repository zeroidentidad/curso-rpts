...
$clases_array = $clases->leerClasesLibro($conn, $libro, $capitulo, $clase);
...
<!--<page backtop="14mm" backbottom="14mm" backleft="10mm" backright="10mm" style="font-size: 12pt" backimg="../imgs/logo.fw.png">
	<h1 style="text-align: center;"> 
		print $libros_array["titulo"];
	</h1>
	<h3 style="text-align: center;">
		print $libros_array["subtitulo"];
	</h3>
</page>-->
	...
	<?php	
		...
		print '<br><p><b>Introducción:</b> '.html_entity_decode($capitulos_array["introduccion"]).'</p>';
			...
			$t = $clases_array["capitulo"].".".$clases_array["clase"];
			$t.= ". ".$clases_array["titulo"];
			print '<br><br>';
			print '<bookmark title="'.$t.'" level="1"></bookmark>';
			print '<h2>'.$t.'</h2>';
			print '<br>';
			print "<div class='nivel'>";
			print html_entity_decode($clases_array["texto"]);
			print '<br>';
			print '<p style="text-align: right;">Video: '.$clases_array["video"]."</p>";
			print "</div>";
			print '</page>';
	?>